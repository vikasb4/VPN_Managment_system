    ...
    allTeams ? (
      ...
      <h2 style={{ marginLeft: "auto" }}>
        ...
        <label style={{ color: "red" }}>
          {availableVPNTeams[this.state.selectedTeam] - teamCurrentConnections}
        </label>
      </h2>
    );
  showVPNInfo = () => {
    ...
    const teamCurrentConnections = allTeams
      ...
      : this.state.currentConnections.filter(
          (curUser) =>
            Object.values(usersData).find((_) => curUser.name === _.name)
      ...
      <div className="column">
        <div className="row" style={{ marginRight: "5px", marginLeft: "20px" }}>
          <h2>
            ...
            <label style={{ color: "blue" }}>{teamCurrentConnections}</label>
          </h2>
  ...
  render() {
    return (
      <div className="App">
        <div>
          ...
          >
            ...
            >
              ...
              <Dropdown.Item eventKey="BI Sovereign" onSelect={this.selectTeam}>
                BI Sovereign
              </Dropdown.Item>
        ...
        <p style={{ color: "red" }}>
          <b>
            **Users are to set their VPN setting when they connect and
            disconnect to VPN. ** Priority 3 users must disconnect when the
            available number of VPN connections goes to or below 3. Those that
            have been on longest should disconnect first.**
          </b>
        </p>
          ...
          <div className="column">
            ...
            <Team
              ...
              teamList={[
                ...
                701,
                702,
                703,704,705,706,707,400,401,402,403,403,405,406,407,408,409
              ]}
              currentlyConnected={this.state.currentConnections}
              timeUsed={this.state.timeUsed}
              using={this.using}
