              ...
              <ListGroup>
                {this.state.teamList
                  ...
                  .map((userId) => {
                    return (
                      <ListGroup.Item
                        style={{ height: "5rem", padding: "0px" }}
                      >
                        <label
                          style={{ fontSize: "2rem", marginBottom: "0px" }}
                        >
                          {data[userId].name}
                        </label>{" "}
                        <Toggle
                          ...
                          time={this.getTimerValue(userId)}
                          start={
                            this.state.currentlyConnected.find(
                              (_) => _.name === data[userId].name
                            ) != null
                          ...
                          Handler={this.Handler.bind(this, userId)}
                        />
                      </ListGroup.Item>
                    );
                  })}
